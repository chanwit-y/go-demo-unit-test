...
func (_m *MockRepository) Create(data entity.Product) (entity.Product, error) {
	ret := _m.Called(data)
...
func (_m *MockRepository) Find() ([]*entity.Product, error) {
	ret := _m.Called()
...
func (_m *MockRepository) Update(data entity.Product) error {
	ret := _m.Called(data)
